...
namespace proyecto_compi111.Analizadores
{
 ...
 SENTENCIAS_DATOS.Rule =  TK_MENOR + TK_BACKGROUND + TK_MAYOR + SENTENCIAS_BACKGROUND + TK_MENOR + TK_DIAGONAL + TK_BACKGROUND + TK_MAYOR 
         ...
         /*   SENTENCIAS_CICLO_VILLANOS*/
            ...
            SENTENCIAS_BONUS.Rule =   TK_LETRAS + TK_PARENTESIS_A + TK_NUMEROS + TK_COMA + TK_NUMEROS + TK_PARENTESIS_C  + TK_PUNTOYCOMA
                                        | TK_LETRAS + TK_PARENTESIS_A + TK_NUMEROS + TK_COMA + TK_NUMEROS + TK_PARENTESIS_C + TK_PUNTOYCOMA;
